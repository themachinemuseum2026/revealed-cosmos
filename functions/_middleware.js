...
<style id="trc-navigation-and-form-fixes">
  html {
...
<script id="trc-navigation-and-form-fixes">
(function () {
...
export async function onRequest(context) {
  ...
  if (!html.includes('id="trc-navigation-and-form-fixes"')) {
    html = html
      .replace('</head>', `${INJECTED_STYLE}\n</head>`)
      .replace('</body>', `${INJECTED_SCRIPT}\n</body>`);
  }
